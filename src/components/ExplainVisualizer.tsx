...
export default function ExplainVisualizer() {
  ...
  return (
    <div className="mx-auto max-w-7xl p-4 space-y-4">
      ...
      {/* Golden Layout: Left (input + analysis), Center (diagram), Right (details) */}
      <div className="grid grid-cols-12 gap-4">
        {/* Left panel */}
        <div className="col-span-12 lg:col-span-3 space-y-3 lg:sticky lg:top-4 self-start">
          ...
          {/* Analysis stays visible below input */}
          <AnalysisPanel alerts={alerts} selectedId={selectedId} />
        </div>
        ...
        {/* Right panel: Details */}
        <div className="col-span-12 lg:col-span-3 lg:sticky lg:top-4 self-start">
